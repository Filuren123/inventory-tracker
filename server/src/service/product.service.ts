...
export class ProductService {
  ...
  async updateProduct(
    ...
    await productItem.update({
      ean_code: data.ean_code !== undefined ? data.ean_code : productItem.ean_code,
      name: data.name ?? productItem.name,
      brand: data.brand !== undefined ? data.brand : productItem.brand,
      category_id: data.category_id !== undefined ? data.category_id : productItem.category_id,
      default_storage_location: data.default_storage_location !== undefined ? data.default_storage_location : productItem.default_storage_location,
      minimum_quantity: data.minimum_quantity ?? productItem.minimum_quantity,
      package_size: data.package_size !== undefined ? data.package_size : productItem.package_size,
      unit: data.unit !== undefined ? data.unit : productItem.unit,
      min_price: data.min_price !== undefined ? data.min_price : productItem.min_price,
      min_price_location: data.min_price_location !== undefined ? data.min_price_location : productItem.min_price_location,
